This python script examines the neighbours of a polygon (buildings) shapefile and draws red points on each polygon with more than one neighbour using PyQGIS.
